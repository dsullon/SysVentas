...
employeeFactory, evaluationCriteriaFactory, evaluationFactory) {
  ...
  employeeFactory.getOne($stateParams.evaluator).success(function(data)
  {
  ...
  $timeout(function(){
    if($scope.evaluation != null){
      ...
      evaluationFactory.getQuestions($stateParams.id, $stateParams.evaluator, $stateParams.evaluated).success(function(data)
      {
      ...
      evaluationFactory.getCommentsToEvaluation($scope.evaluation.id, $stateParams.evaluator, $stateParams.evaluated, 0).success(function(data)
      {
